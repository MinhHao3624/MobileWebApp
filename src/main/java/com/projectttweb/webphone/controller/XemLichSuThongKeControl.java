 ...
 */
@WebServlet("/xemLichSuThongKe")
public class XemLichSuThongKeControl extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public XemLichSuThongKeControl() {
        super();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            ArrayList<Orders> lst = ordersDAO.getListByNhanVienTK(userID, todaysDate, previousMonthDate);
            Gson gson = new Gson();
