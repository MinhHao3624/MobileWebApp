...
public class JDBCUtil {
	...
	public static Connection getConnection() throws ClassNotFoundException  {
		...
		try {
			...
			// Các thông số
			String url = "jdbc:mySQL://localhost:3306/mobilewebapp?useUnicode=true&characterEncoding=UTF-8&characterSetResults=UTF-8&connectionCollation=utf8mb4_unicode_ci";
